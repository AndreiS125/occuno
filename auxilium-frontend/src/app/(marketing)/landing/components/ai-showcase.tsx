...
export default function AiShowcase({ className }: AiShowcaseProps) {
  ...
  const agents = [
    ...
    },
    {
      ...
      icon: Search,
      color: "secondary",
      description: "Multi-agent with planning and research",
      capabilities: [
      ...
      demo: {
        ...
        research: [
          "Analyzing top productivity podcasts...",
          "Researching target audience preferences...", 
          "Finding optimal publishing platforms...",
          "Identifying trending topics in productivity..."
        ],
        output: [
    ...
    },
    {
      ...
      icon: Cpu,
      color: "accent",
      description: "Top LLMs with maximum research power",
      capabilities: [
        "Advanced reasoning",
      ...
      demo: {
        ...
        research: [
          ...
          "Funding landscape and investor research...",
