...
def get_enhanced_gamification_stats(
    ...
    achievement_definitions = gamification.get_user_achievements()
...
def get_daily_status(
    ...
    try:
        status = gamification.get_daily_status()
...
def open_mystery_box(
    ...
    try:
        result = gamification.open_mystery_box(frontend_choice=request.frontend_choice)
...
def claim_daily_bonus(
    ...
    try:
        result = gamification.claim_daily_bonus()
        return result
    except Exception as e:
...
def get_available_coupons(
    ...
    try:
        result = gamification.get_available_coupons()
        return result
    except Exception as e:
...
def use_coupon(
    ...
    try:
        ...
        result = gamification.use_coupon(coupon_uuid)
        return result
    except ValueError:
...
def get_coupon_definitions(
    ...
    try:
        definitions = gamification.get_coupon_definitions()
        return [
...
def get_gamification_stats(
    ...
    profile = user_repo.ensure_default_profile()
...
def get_achievement_definitions(
    ...
    achievements = gamification.get_user_achievements()
    return [
        {
            "id": ach.id,
            "name": ach.name,
...
def get_luck_status(
    ...
    try:
        ...
        user_profile = user_repo.ensure_default_profile()
...
def save_reward_configuration(
    ...
    try:
        ...
        from core.models import CustomRewardConfiguration, CustomRewardTier
...
def delete_reward_configuration(
    user_repo = Depends(get_user_repo)
):
...
def toggle_reward_configuration(
    request: dict,
    user_repo = Depends(get_user_repo)
):
